...
```{r}
pal = c(January="#555555", February="#ffff00", March="#000000", April="#0000ff",
        May="#00aa00", June="#ff9900", July="#00ffff", August="#ff00ff",
        September="#55aa11", October="#aa9944", November="#77ffaa", December="#ccaa99")
clr = as.vector(pal[bounty$month])
...
map = addLegend(map, position="bottomright", colors=unique(clr),
        labels=unique(names(pal)[bounty$month]), title="Month", opacity=1)
map
```
